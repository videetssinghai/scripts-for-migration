...
def hello_world():
	...
	# print client_ip
	# contact neighbourhood cloudlets, send requests to them containing IP on MD.
	'''
	...
	connection.close()
	'''
	#make those neighbours ping Mobile MD and give you their rtt as a response
	#select neighbour with minimum rtt to migrate to. 
	threshold = 50
